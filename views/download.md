...
<table class="versions">
  ...
  <tr>
    ...
    <br>
    <strong>Note: we are not aware of bugs in 2.6.0-RC4, but it's new code, so handle it with care if you plan to use it in production environments.</strong>
    <br>
    <td>
      <a href="http://redis.googlecode.com/files/redis-2.6.0-rc4.tar.gz">Download</a>
    </td>
  </tr>
