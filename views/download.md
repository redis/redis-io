...
<table class="versions">
  <tr class="current">
    ...
    <br>
    <td>
      <a href="http://redis.googlecode.com/files/redis-2.2.6.tar.gz">Download</a>
    </td>
  </tr>
